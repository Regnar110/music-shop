...
const ShopMenu = ({ history }) => {
    return (
        <nav className='shop-side-menu'>
            ...
            <div className='shop-menu-item' onClick={() => history.push(`/shop/top10`)}><img alt='top ten' src={topten}/>Top 10 news</div>
            ...
            <div className='shop-menu-item'>
                ...
                <div className='menu-item-dropdown'>
                    ...
                    <span className='shop-menu-item-dropdown-item' onClick={() => history.push(`/shop/rap`)}><img alt='arrow' src={arrow}/>Hip-Hop/Rap</span>
